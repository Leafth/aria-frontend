...
import { CreditCardIcon, Edit2Icon, EllipsisIcon, Trash2Icon } from 'lucide-react';
...
export const columns: ColumnDef<Invoice>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => <DataTableColumnHeader column={column} title={<div className="flex items-center gap-1">
      ...
      return (
        <div className="flex justify-end">
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem onSelect={() => alert(`Edit ${invoice.invoice}`)}>
                <Edit2Icon className="size-4" /> Edit
              </DropdownMenuItem>
              <DropdownMenuItem onSelect={() => alert(`Delete ${invoice.invoice}`)}>
