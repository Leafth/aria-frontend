...
export function Header({ title, description, active, breed, page }: HeaderProps) {
  return (
      ...
      <h1 className="flex items-center gap-4 text-xl font-semibold text-text-primary lg:text-2xl">
        ...
        {page === "individual" && (
          <div className="flex items-center gap-4">
            ...
            {active === "Inativa" && (
              <div className="flex items-center rounded-md px-4 h-7 bg-red-400">
                <p className="text-red-700 text-xs">{active}</p>
              </div>
            )}
